...
def _codec_error_un_quote(e: UnicodeError) -> tuple[str, int]:
...
codecs.register_error("werkzeug.un_quote", _codec_error_un_quote)
...
def _make_unquote_part(name: str, chars: str) -> t.Callable[[str], str]:
    ...
    def _unquote_partial(value: str) -> str:
        ...
        for part in parts:
            out.append(unquote(part, "utf-8", "werkzeug.unquote"))
